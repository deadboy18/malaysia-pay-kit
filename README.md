...
Or just grab the JSON files directly from [`/data/`](data/).
...
│   ├── acquirers.json              # 62 DuitNow QR acquirers
...
|------|---------|-------------|
| [`banks.json`](data/banks.json) | 46 | All Malaysian banks — conventional, Islamic arms, digital banks. IBG, BIC, routing ID, acquirer ID, FPX IDs, account formats per type. |
| [`ewallets.json`](data/ewallets.json) | 9 | TNG, GrabPay, Boost, ShopeePay, BigPay, Merchantrade, etc. Proxy vs account pay flags, app store links. |
| [`acquirers.json`](data/acquirers.json) | 62 | PayNet DuitNow QR acquirers — banks, e-wallets, processors. |
| [`fpx-banks.json`](data/fpx-banks.json) | 52 | FPX bank IDs with retail/corporate mode flags. |
| [`states.json`](data/states.json) | 16 | All states/FT with IC codes, lat/lng, area codes, postcode ranges. |
| [`phone-prefixes.json`](data/phone-prefixes.json) | 10 prefixes | Complete mobile prefix-to-carrier mapping including 011 sub-ranges. |
| [`ic-state-codes.json`](data/ic-state-codes.json) | 88 | All MyKad birth state/country codes. |
| [`transaction-codes.json`](data/transaction-codes.json) | 89 | Payment types: FPX, card, DuitNow QR, e-wallets, BNPL, instalment plans per bank. |
| [`response-codes/fpx.json`](data/response-codes/fpx.json) | 77 | FPX response codes with descriptions. |

### [`/validators/`](validators/) — Ready-to-use validation

| Validator | What It Does |
|-----------|-------------|
| [`account-number.js`](validators/account-number.js) | Validates account number by bank (46 banks × 5 account types). Handles CIMB dual lengths, ICBC prefix rules, UOB variable formats. |
| [`phone-number.js`](validators/phone-number.js) | Malaysian phone validation, +60 normalization, carrier detection from prefix, mobile/landline/VoIP classification. |
| [`ic-number.js`](validators/ic-number.js) | MyKad/NRIC: birth date, state, gender extraction from 12-digit IC. |
| [`duitnow-qr.js`](validators/duitnow-qr.js) | EMV QR TLV decoder, CRC16 validation, static QR generator. |
| [`postcode.js`](validators/postcode.js) | 5-digit postcode validation, state lookup. |
| [`business-reg.js`](validators/business-reg.js) | SSM registration number (old + new format). |

### [`/docs/`](docs/) — Comprehensive documentation

| File | Description |
|------|-------------|
| [`bank-codes.md`](docs/bank-codes.md) | Cross-reference table: IBG + BIC + FPX + acquirer + routing per bank |
| [`account-formats.md`](docs/account-formats.md) | Account number lengths per bank per type, special cases |
| [`fpx-reference.md`](docs/fpx-reference.md) | FPX bank IDs, response codes, ID types, developer tips |
| [`response-codes.md`](docs/response-codes.md) | 500+ response codes across all payment types |
| [`duitnow-qr-research.md`](docs/duitnow-qr-research.md) | Community QR reverse engineering (natsu90 + contributors) |
| [`paynet-developer-docs.md`](docs/paynet-developer-docs.md) | Full PayNet docs scraped to markdown |
| [`resources.md`](docs/resources.md) | Curated links to all community repos and official docs |
| [`icon-inventory.md`](docs/icon-inventory.md) | Icon audit: what's available vs what needs creating |

### [`/icons/`](icons/) — SVG payment icons
...
> **Important:** Dynamic QR codes require PayNet acquirer integration. Only static QR can be generated client-side. See [`docs/duitnow-qr-research.md`](docs/duitnow-qr-research.md) for details.
...
1. Fork this repo
2. Update the relevant JSON file in [`/data/`](data/)
3. Update the corresponding doc in [`/docs/`](docs/) if needed
